  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}text-white`}>Hi, I'm <span className='text-[#9152ff]'>Gaurav</span></h1>
          <p className={`${styles.heroSubText}mt-2 text-white-100`}>
            I develop Front-End web application <br className='sm:block hidden' /> and user interfaces.
          </p>
        </div>
