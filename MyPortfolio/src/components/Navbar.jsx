...
const Navbar = () => {
  ...
  // const [scrollTo, setScroll]= useState()
    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        onClick={()=>{
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Gaurav &nbsp; <span className='sm:block hidden'>| FrontEnd Developer</span></p>
        </Link>
